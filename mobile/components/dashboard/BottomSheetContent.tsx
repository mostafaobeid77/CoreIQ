      ...
      <View style={styles.sheetContent}>
        ...
        <ScrollView style={styles.sheetScrollView} showsVerticalScrollIndicator={false}>
          <View style={styles.sheetCards}>
            ...
            <View style={styles.card}><Ionicons name="fitness" size={24} color="#22c55e" /><Text style={styles.cardTitle}>Proteins</Text><Text style={styles.cardValue}>{consumedNutrients.totalProtein} / {dailyTargets.proteins}g</Text></View>
